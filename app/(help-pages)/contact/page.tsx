      ...
      <article className="grid items-center gap-8 container max-w-3xl py-8 md:py-10 lg:py-10">
        <section className="grid gap-1">
          ...
          <p className="text-muted-foreground max-w-[750px] text-base sm:text-lg">
            Contact us for any questions or concerns about MegaMart.
          </p>
        </section>
        ...
        <section className="mdx">
          <p className="text-base leading-7 [&:not(:first-child)]:mt-5 mb-10">
            If you have any questions or concerns about MegaMart, please contact
            us using one of the methods below. We will try to respond as soon as
            possible.
          </p>
          <Contact />
