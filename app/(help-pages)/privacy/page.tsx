      ...
      <article className="grid items-center gap-8 container max-w-3xl py-8 md:py-10 lg:py-10">
        ...
        <section className="mdx">
          <p>
            ...
            obcaecati nesciunt repudiandae dolorum nisi accusantium expedita,
            enim, aliquam vitae ratione omnis sint! Inventore fugiat nihil
            accusantium hic, iure harum vero!
          </p>
          <br />
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores
